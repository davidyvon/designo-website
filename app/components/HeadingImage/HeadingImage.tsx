...
const Heading = ({ blok }: HeadingProps): JSX.Element => {
	...
	return (
		...
		>
			...
			<div className='grid-container py-20 md:py-16 md:px-0 bg-peach text-white rounded-b-2xl lg:rounded-l-2xl lg:rounded-r-none col-span-full md:col-end-9 lg:col-end-8'>
